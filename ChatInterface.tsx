...
export default function ChatInterface() {
  ...
  // FIX: Extract the core submission logic into its own function so it can be
  // called from both the form's onSubmit handler and the textarea's onKeyDown
  // handler without passing a KeyboardEvent where a FormEvent is expected.
        ...
        <form onSubmit={handleSubmit} className="flex gap-2 items-end">
          <div className="flex-1 bg-stone-100 rounded-2xl border border-stone-200 focus-within:border-orange-500 focus-within:ring-1 focus-within:ring-orange-500 transition-all flex items-end p-1">
            ...
            <textarea
              ...
              onKeyDown={(e) => {
                // FIX: call submitMessage directly instead of passing the KeyboardEvent
                // to handleSubmit, which expects a React.FormEvent.
